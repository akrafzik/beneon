                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <ol class="breadcrumb">
                                    <li class="active">
                                        <i class="fa fa-dashboard"></i> Lista de Posts
                                    </li>
                                </ol>
                        ...
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="col-lg-12">
                                    <a href="inserir-posts" class="btn btn-primary">Cadastrar Novo</a>
                                </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover table-striped">
                                    <thead>
                                        <tr>
                                            <th>Título</th><th>Resumo</th><th>Imagem</th>
                                            <th>Mauntenção</th>
                                        </tr>
                                    </thead>
                                    <tbody id="res">
                                        <?php
                                        $itens = gettblPostPaginacao( 1 );
                                        foreach ( $itens[ "pagina" ] as $item ) {
                                            ?>
                                            <tr>
                                                <td><?= $item[ "postTitulo" ] ?></td><td><?= $item[ "postResumo" ] ?></td><td><img src="<?= $item[ "foto" ] ?>" style="width:100px;"></td>
                                                <td>
                                                    <a href="alterar-posts/<?= $item[ "postID" ] ?>/">Alterar</a> || <a href="javascript:void(0);" onclick="removerRegistro('<?= $item[ "postID" ] ?>')" >Excluir</a><br>
                                                </td>
                                            </tr>
                                            <?php
                                        }
